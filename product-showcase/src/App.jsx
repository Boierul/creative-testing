                    ...
                    <div className="main-wrapper swiper-wrapper">
                        <div className="main swiper-slide" id="beach">
                            <div className="left-side">
                                ...
                                <div className="main-content">
                                    <div className="main-content__title">In 20 years, there could be more plastic in our
                                        oceans than fish.
                                    </div>
                                    <div className="main-content__subtitle">Plastic pollution injures more than 100.000
                                        marine animals every year.It takes around 450 years for one plastic bottle to
                                        decompose.
                                    </div>
                                    <div className="more-menu">
                                        Shop Now
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.7"
                        ...
                        <div className="main swiper-slide" id="savanna">
                            <div className="left-side">
                                ...
                                <div className="main-content">
                                    <div className="main-content__title">The Earth’s area affected by desertification is
                                        approx 11 times India’s size.
                                    </div>
                                    <div className="main-content__subtitle">The Savannas act as a carbon sink, absorbing
                                        CO2 from the atmosphere and helping to maintain the balance of global
                                        temperatures.
                                    </div>
                                    <div className="more-menu">
                                        Shop Now
                        ...
                        <div className="main swiper-slide" id="glacier">
                            <div className="left-side">
                                ...
                                <div className="main-content">
                                    ...
                                    <div className="main-content__subtitle">The effects of melting ice glaciers are
                                        biodiversity loss, the rising of the sea level and the deficiency of freshwater,
                                        among others.
                                    </div>
                                    <div className="more-menu">
                                        Shop Now
                        ...
                        <div className="main swiper-slide" id="coral">
                            <div className="left-side">
                                ...
                                <div className="main-content">
                                    <div className="main-content__title">We will have lost 60% of our coral reefs by
                                        2030.
                                    </div>
                                    <div className="main-content__subtitle">Coral reefs are essential to humans, as they
