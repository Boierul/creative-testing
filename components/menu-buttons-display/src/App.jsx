...
function App() {
    ...
    useEffect(() => {
        ...
        script.src =
            "https://s3-us-west-2.amazonaws.com/s.cdpn.io/409445/animateAnything.js";
        script.async = true;
        ...
        <>
            ...
            <div id="container">
                ...
                <div id="b4" className="box">
                    <svg id="i4" className="icon" viewBox="0 0 100 100">
                ...
                <div id="b5" className="box">
                    <svg id="i5" className="icon" viewBox="0 0 100 100">
                ...
                <div id="b6" className="box">
                    <svg id="i6" className="icon" viewBox="0 0 100 100">
