    ...
    return (
        <>
            ...
            <div className="layout">
                <div className="box">High-end, full-service<br />visual content creation<br />for lifestyle branding.</div>
            </div>

            <a href="https://www.supah.it" target="_blank" className="logo">S</a>
