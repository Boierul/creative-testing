    ...
    return (
        <>
            <svg viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
                <rect width="100%" height="100%" fill="#C54BB0"/>
                <circle className="sun" cx="400" cy="300" r="270" fill="#FAEFBE"/>
                <rect x="0" y="400" width="800" height="200" fill="url(#exampleGradient)"/>
                <defs>
                    <radialGradient id="exampleGradient">
                        <stop offset="30%" stop-color="#7a378b"/>
                        <stop offset="99%" stop-color="#C54BB0"/>
                    </radialGradient>
                </defs>
                <rect x="0" y="100" width="800" height="5" fill="#C54BB0"/>
                <rect x="0" y="140" width="800" height="10" fill="#C54BB0"/>
                <rect x="0" y="210" width="800" height="25" fill="#C54BB0"/>
                ...
                <rect className="lights" x="195" y="191" width="35px" height="6px" fill="#544e75 "/>
                <rect x="165" y="251" width="55px" height="6px" fill="#544e75    "/>
                <rect className="lights" x="205" y="265" width="25px" height="6px" fill="#544e75    "/>
                ...
                <rect className="lights" x="65" y="419" width="45px" height="2px" fill="#14d3c2    "/>
                ...
                <rect className="lights" x="713" y="429" width="65px" height="2px" fill="#14d3c2    "/>
                ...
                <rect className="lights" x="437" y="125" width="10px" height="6px" fill="#544e75    "/>
                ...
                <rect className="lights" x="457" y="145" width="10px" height="6px" fill="#544e75    "/>
                ...
                <rect className="lights" x="555" y="165" width="45px" height="6px" fill="#544e75    "/>
                ...
                <rect className="lights" x="123" y="376" width="105px" height="2px" fill="#C54BB0  "/>
                ...
                <rect className="lights" x="123" y="416" width="105px" height="2px" fill="#C54BB0  "/>
                ...
                <rect className="lights" x="592" y="341" width="105px" height="3px" fill="#faefbe "/>
                <rect x="592" y="361" width="105px" height="3px" fill="#273466  "/>
                <rect x="592" y="381" width="105px" height="3px" fill="#faefbe "/>
                <rect className="lights" x="592" y="401" width="105px" height="3px" fill="#faefbe "/>
                <rect x="592" y="421" width="105px" height="3px" fill="#273466  "/>
                <rect x="592" y="441" width="105px" height="3px" fill="#faefbe "/>


                <circle className="star" cx="40" cy="100" r="2" fill="#fff"/>
                <circle className="star" cx="120" cy="150" r="2" fill="#fff"/>
                <circle className="star" cx="740" cy="60" r="2" fill="#fff"/>
                <circle className="star" cx="240" cy="40" r="2" fill="#fff"/>
                <circle className="star" cx="70" cy="240" r="2" fill="#fff"/>
                <circle className="star" cx="690" cy="140" r="2" fill="#fff"/>
                <circle className="star" cx="790" cy="240" r="2" fill="#fff"/>
            </svg>
        </>
    )
}
